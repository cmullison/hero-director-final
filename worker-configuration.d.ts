/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bc417051526da2d5459549aaf3211f01)
// Runtime types generated with workerd@1.20250416.0 2025-05-16 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface Env {
		ACCOUNT_ID: "1e9408c2be90eae9689a2b6942ca5d87";
		GATEWAY_ID: "mulls-io";
		...
		EmailAgent: DurableObjectNamespace<import("./src/server").EmailAgent>;
		MockEmailService: DurableObjectNamespace<import("./src/server").MockEmailService>;
		Chat: DurableObjectNamespace<import("./src/server").Chat>;
		Rpc: DurableObjectNamespace<import("./src/server").Rpc>;
		Main: DurableObjectNamespace<import("./src/server").Main>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ACCOUNT_ID" | "GATEWAY_ID" | "MODEL">> {}
}
